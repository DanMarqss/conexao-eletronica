    ...
    const eventData = [
        {
            ...
            title: "Illusionize",
            date: "11 ABR 2025",
            image: "img/flyer-illusionize.png",
            description: "A Casa Rayol da Ponta Negra é um espaço de convivência e eventos à beira do Rio Negro, conhecido pela ampla varanda de madeira que se projeta sobre as águas. Frequentada tanto por moradores quanto por turistas, oferece uma atmosfera descontraída ao som de música ao vivo, DJs e projetos culturais. Com vista panorâmica do rio e do pôr do sol, é palco de encontros, celebrações e pequenas feiras de arte e gastronomia.",
            lineup: ["Illusionize", "Visage"],
            venue: "Casa Rayol",
            venueDescription: "Localizada na orla da Ponta Negra, a Casa Rayol ocupa uma construção histórica com varanda em deck de madeira suspensa sobre o rio. Internamente, possui ambientes integrados: um salão rústico com mobiliário de madeira, espaço para shows intimistas e bar central; e externamente, um deque amplo com bancos e mesas, ideal para apreciar o pôr do sol. A estrutura conta ainda com sistema de som, iluminação cênica e equipe de atendimento para eventos particulares, casamentos e festas temáticas, tudo emoldurado pela paisagem fluvial de Manaus.",
            venueLink: "https://www.instagram.com/ama.producoes?igsh=NzczbDY3MGs4NHIx",
            ticketLink: "https://baladapp.com.br/pt-BR/eventos/pump-illusionize/6404",
        },
        {
            id: 2,
